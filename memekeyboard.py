...
#paths to the video for each key
video_pathA="vine A.mp4"
video_pathB="vine B.mp4"
video_pathC="vine C2.mp4"
video_pathD="vine D.mp4"
video_pathE="vine E.mp4"
video_pathF="vine F.mp4"
video_pathG="vine G.mp4"
video_pathH="vine h3.mp4"
video_pathI="vine I2.mp4"
video_pathJ="vine J.mp4"
video_pathK="vine K.mp4"
video_pathL="vine L2.mp4"
video_pathM="vine M.mp4"
video_pathN="vine N2.mp4"
video_pathO="vine O.mp4"
video_pathP="vine P2.mp4"
video_pathQ="vine Q.mp4"
video_pathR="vine R.mp4"
video_pathS="vine S2.mp4"
video_pathT="vine T.mp4"
video_pathU="vine U2.mp4"
video_pathV="vine V.mp4"
video_pathW="vine W2.mp4"
video_pathX="vine X.mp4"
video_pathY="vine Y.mp4"
video_pathZ="vine Z.mp4"
video_pathSPACE="vine spacebar.mp4"
video_pathENTER="vine enter.mp4"


#defs for each key to be linked to the video 
...
def PlayVideoSPACE(video_pathSPACE):
    videoSPACE=cv2.VideoCapture(video_pathSPACE)
    player = MediaPlayer(video_pathSPACE)
    while True:
        grabbed, frame=videoSPACE.read()
        audio_frame, val = player.get_frame()
        if not grabbed:
            print("End of video")
            break
...
def PlayVideoENTER(video_pathENTER):
    videoENTER=cv2.VideoCapture(video_pathENTER)
    player = MediaPlayer(video_pathENTER)
    while True:
        grabbed, frame=videoENTER.read()
        audio_frame, val = player.get_frame()
        if not grabbed:
            print("End of video")
            break
...
while True:
    ...
    if keyboard.is_pressed('h') == True:
        videoH = PlayVideoH(video_pathH)
        videoH.release()

    if keyboard.is_pressed('i') == True:
        videoI = PlayVideoI(video_pathI)
        videoI.release()

    if keyboard.is_pressed('j') == True:
        videoJ = PlayVideoJ(video_pathJ)
        videoJ.release()
    ...
    if keyboard.is_pressed('space') == True:
        videoSPACE = PlayVideoSPACE(video_pathSPACE)
        videoSPACE.release()

    if keyboard.is_pressed('enter') == True:
        videoENTER = PlayVideoENTER(video_pathENTER)
        videoENTER.release()
